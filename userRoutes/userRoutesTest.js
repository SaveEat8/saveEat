...
const userController=require('../userControllers/userControllerTest.js');
...
//=========================Webhook Apis==========================================//
userRoutes.post('/dunzoWebHook',userController.dunzoWebHook);
userRoutes.post('/cleverTapWebHook',userController.cleverTapWebHook);
...
userRoutes.post('/updateBrandServiceStatus',brandController.updateBrandServiceStatus);
...
userRoutes.post('/formattedAddress',userController.formattedAddress);
...
userRoutes.get('/getUserCreditHistory',userController.getUserCreditHistory);
...
userRoutes.post('/updateCurrentLocation',userController.updateCurrentLocation);
userRoutes.post('/addToCart',userController.addToCart);
userRoutes.post('/updatedEstimatePrice',userController.updatedEstimatePrice);
...
//address
userRoutes.post('/addUserAddress',userController.addUserAddress);
userRoutes.post('/updateUserAddress',userController.updateUserAddress);
userRoutes.post('/getUserAddress',userController.getUserAddress);
userRoutes.post('/deleteUserAddress',userController.deleteUserAddress);
